...
export default function Home() {
  return (
    <main className="relative w-screen h-screen overflow-hidden bg-black flex items-center justify-center">
      ...
      {/* 2. Main Content (Centered Track Display) */}
      ...
      {/* 3. PIP Gesture Camera (Top Right) */}
      <div className="fixed top-6 right-6 w-72 h-48 rounded-2xl overflow-hidden border border-green-500/20 shadow-[0_0_30px_rgba(30,215,96,0.2)] z-40 bg-black group">
      ...
      {/* 4. Overlays & UI Layers */}
      <HandUI />
      <NotificationSystem />

      {/* Bottom Left Stack: Gesture Guide + Testing Panel */}
      <div className="fixed bottom-6 left-6 z-30 flex flex-col gap-4">

        {/* Gesture Guide (Restored) */}
        <div className="bg-black/80 backdrop-blur-md border border-green-500/30 rounded-xl p-4 text-green-100 font-mono text-xs tracking-wider shadow-[0_0_20px_rgba(30,215,96,0.1)] w-64">
          ...
          <ul className="space-y-2">
            <li className="flex items-center gap-3">
              ...
              <div><span className="text-green-300 font-bold">GRAB</span> <span className="text-[10px] opacity-70">PAUSE</span></div>
            </li>
            <li className="flex items-center gap-3">
              <span className="text-xl">🖐️</span>
              <div><span className="text-green-300 font-bold">PALM</span> <span className="text-[10px] opacity-70">PLAY</span></div>
            </li>
            <li className="flex items-center gap-3">
              <span className="text-xl">✌️</span>
      ...
      <div className="absolute top-8 left-8 z-50 pointer-events-none">
        <h1 className="text-4xl font-black text-white tracking-tighter font-mono italic opacity-90">
          JHOOM IT
        </h1>
